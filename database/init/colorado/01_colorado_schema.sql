-- database/init/colorado/01_colorado_schema.sql
-- Colorado Tenant Database Schema
-- This runs when colorado-db container starts
...
-- Tenants table (single tenant for Colorado)
